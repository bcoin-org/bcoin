...
Golomb `golomb` is a module intended to be used as a Golomb Coded Set
for creating Compact Block Filters as specified in [BIP 158](https://github.com/bitcoin/bips/blob/master/bip-0158.mediawiki).
It is used to create block filters which can be used to quickly scan
blocks for a given set of transaction outputs.
...
customarily set to 2^P. [BIP 158](https://github.com/bitcoin/bips/blob/master/bip-0158.mediawiki)
defines the value of P as 19, based on results from real world block data.
