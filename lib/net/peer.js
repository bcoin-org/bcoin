...
Peer.prototype.__onPacket = co(function* onPacket(packet) {
  ...
  switch (packet.type) {
    ...
    case packetTypes.VERACK:
      return yield this._handleVerack(packet);
    case packetTypes.PING:
      return yield this._handlePing(packet);
    case packetTypes.PONG:
      return yield this._handlePong(packet);
    ...
    case packetTypes.ADDR:
      return yield this._handleAddr(packet);
    case packetTypes.INV:
      return yield this._handleInv(packet);
    case packetTypes.GETDATA:
      return yield this._handleGetData(packet);
    case packetTypes.NOTFOUND:
      return yield this._handleNotFound(packet);
    ...
    case packetTypes.HEADERS:
      return yield this._handleHeaders(packet);
    case packetTypes.SENDHEADERS:
      return yield this._handleSendHeaders(packet);
    case packetTypes.BLOCK:
      return yield this._handleBlock(packet);
    case packetTypes.TX:
      return yield this._handleTX(packet);
    case packetTypes.REJECT:
      return yield this._handleReject(packet);
    case packetTypes.MEMPOOL:
      return yield this._handleMempool(packet);
    case packetTypes.FILTERLOAD:
      return yield this._handleFilterLoad(packet);
    case packetTypes.FILTERADD:
      return yield this._handleFilterAdd(packet);
    case packetTypes.FILTERCLEAR:
      return yield this._handleFilterClear(packet);
    case packetTypes.MERKLEBLOCK:
      return yield this._handleMerkleBlock(packet);
    case packetTypes.GETUTXOS:
      return yield this._handleGetUTXOs(packet);
    case packetTypes.UTXOS:
      return yield this._handleUTXOs(packet);
    case packetTypes.HAVEWITNESS:
      return yield this._handleHaveWitness(packet);
    case packetTypes.FEEFILTER:
      return yield this._handleFeeFilter(packet);
    case packetTypes.SENDCMPCT:
      return yield this._handleSendCmpct(packet);
    case packetTypes.CMPCTBLOCK:
    ...
    case packetTypes.UNKNOWN:
      return yield this._handleUnknown(packet);
    default:
...
Peer.prototype._handleFilterLoad = co(function* _handleFilterLoad(packet) {
...
Peer.prototype._handleFilterAdd = co(function* _handleFilterAdd(packet) {
...
Peer.prototype._handleFilterClear = co(function* _handleFilterClear(packet) {
  if (this.spvFilter)
...
Peer.prototype._handleMerkleBlock = co(function* _handleMerkleBlock(packet) {
...
Peer.prototype._handleFeeFilter = co(function* _handleFeeFilter(packet) {
...
Peer.prototype._handleUTXOs = co(function* _handleUTXOs(utxos) {
...
Peer.prototype._handleHaveWitness = co(function* _handleHaveWitness(packet) {
...
Peer.prototype._handleVerack = co(function* _handleVerack(packet) {
  this.fire('verack');
});
...
Peer.prototype._handleMempool = co(function* _handleMempool(packet) {
  var items = [];
  var i, hashes;
...
Peer.prototype._handleNotFound = co(function* _handleNotFound(packet) {
...
Peer.prototype._handleAddr = co(function* _handleAddr(packet) {
...
Peer.prototype._handlePong = co(function* _handlePong(packet) {
...
Peer.prototype._handleInv = co(function* _handleInv(packet) {
  var items = packet.items;
  var blocks = [];
  var txs = [];
  var unknown = -1;
...
Peer.prototype._handleHeaders = co(function* _handleHeaders(packet) {
...
Peer.prototype._handleSendHeaders = co(function* _handleSendHeaders(packet) {
...
Peer.prototype._handleBlock = co(function* _handleBlock(packet) {
...
Peer.prototype._handleTX = co(function* _handleTX(packet) {
  var tx = packet.tx;
...
Peer.prototype._handleReject = co(function* _handleReject(details) {
  var hash, entry;
...
Peer.prototype._handleAlert = co(function* _handleAlert(alert) {
...
Peer.prototype._handleUnknown = co(function* _handleUnknown(packet) {
...
Peer.prototype._handleSendCmpct = co(function* _handleSendCmpct(packet) {
...
Peer.prototype._handleBlockTxn = co(function* _handleBlockTxn(packet) {
