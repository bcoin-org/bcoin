...
Mempool.prototype.addBlock = function addBlock(block, callback) {
  ...
  callback = this._lock(addBlock, [block, callback]);
...
Mempool.prototype.removeBlock = function removeBlock(block, callback) {
  ...
  callback = this._lock(removeBlock, [block, callback]);
...
Mempool.prototype.getConfidence = function getConfidence(hash, callback) {
  ...
  if (tx && tx.block) {
    return this.chain.db.isMainChain(tx.block, function(err, result) {
      ...
      callback(null, constants.confidence.DEAD);
    });
  }
  ...
  this.chain.db.hasCoins(hash, function(err, existing) {
    ...
    callback(null, constants.confidence.UNKNOWN);
  });
};
