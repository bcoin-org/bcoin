...
class ChainDB {
  ...
  async saveGenesis() {
    ...
    const block = Block.decode(genesis);
...
class ChainFlags extends bio.Struct {
  ...
  /**
   * Inject properties from serialized ChainFlags.
...
class ChainState extends bio.Struct {
  ...
  /**
   * Inject properties from another ChainState.
   * @param {ChainState} state
   * @returns {ChainState}
   */
  ...
  /**
   * Inject properties from serialized ChainState.
   * @param {BufferReader} br
   * @returns {ChainState}
   */
