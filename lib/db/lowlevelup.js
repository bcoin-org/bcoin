...
LowlevelUp.prototype.init = function init() {
  ...
  let db = new Backend(this.location, this.options);
  let binding = db;
...
LowlevelUp.prototype.load = function load() {
  return new Promise((resolve, reject) => {
    this.db.open(this.options, co.wrap(resolve, reject));
  });
};
...
LowlevelUp.prototype.getBlock = async function getBlock(key) {
  return this.binding.getBlock(key);
};

LowlevelUp.prototype.putBlock = async function putBlock(key, value) {
  return this.binding.putBlock(key, value);
};

LowlevelUp.prototype.delBlock = async function delBlock(key) {
  return this.binding.delBlock(key);
};
