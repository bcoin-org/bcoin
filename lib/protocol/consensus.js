...
/**
 * Sigop weight cost for checking a non-empty signature (Tapscript).
 * @const {Number}
 * @default
 */

exports.VALIDATION_WEIGHT_PER_SIGOP_PASSED = 50;

/**
 * Initial sigop weight "budget" added to witness (Tapscript).
 * @const {Number}
 * @default
 */

exports.VALIDATION_WEIGHT_OFFSET = 50;
