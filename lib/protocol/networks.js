...
main.deployments = {
  ...
  taproot: {
    name: 'taproot',
    bit: 2,
    startTime: 1619222400, // April 24th, 2021
    timeout: 1628640000, // August 11th, 2021
    threshold: 1815, // 90% instead of 95%
    window: -1,
    required: false,
    force: false,
    minActivationHeight: 709632 // Approximately November 12th, 2021
  },
  segsignal: {
    name: 'segsignal',
    bit: 4,
