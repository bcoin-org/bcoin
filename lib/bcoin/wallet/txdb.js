...
TXDB.prototype.zap = function zap(account, age, callback) {
  var self = this;
  ...
  callback = this._lock(zap, [account, age, callback]);
...
TXDB.prototype.abandon = function abandon(hash, callback) {
  var self = this;
