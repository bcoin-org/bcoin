 ...
 * @param {Object} options - See {@link Framer.authChallenge}.
 * @returns {Buffer} authChallenge packet.
 */

Framer.prototype.authChallenge = function authChallenge(options) {
  return this.packet('authchallenge', Framer.authChallenge(options));
};

/**
 * Create a authreply packet with a header.
 * @param {Object} options - See {@link Framer.authReply}.
 * @returns {Buffer} authReply packet.
 */

Framer.prototype.authReply = function authReply(options) {
  return this.packet('authreply', Framer.authReply(options));
};

/**
 * Create a authpropose packet with a header.
 * @param {Object} options - See {@link Framer.authPropose}.
 * @returns {Buffer} authPropose packet.
 */

Framer.prototype.authPropose = function authPropose(options) {
  return this.packet('authpropose', Framer.authPropose(options));
};
...
/**
 * Create an authchallenge packet (without a header).
 * @param {Buffer} data
 * @param {BufferWriter?} writer - A buffer writer to continue writing from.
 * @returns {Buffer} Returns a BufferWriter if `writer` was passed in.
 */

Framer.authChallenge = function authChallenge(data, writer) {
  if (writer) {
    writer.writeBytes(data);
    return writer;
  }
...
/**
 * Create an authreply packet (without a header).
 * @param {Buffer} data
 * @param {BufferWriter?} writer - A buffer writer to continue writing from.
 * @returns {Buffer} Returns a BufferWriter if `writer` was passed in.
 */

Framer.authReply = function authReply(data, writer) {
  if (writer) {
    writer.writeBytes(data);
    return writer;
  }
...
/**
 * Create an authPropose packet (without a header).
 * @param {Buffer} data
 * @param {BufferWriter?} writer - A buffer writer to continue writing from.
 * @returns {Buffer} Returns a BufferWriter if `writer` was passed in.
 */

Framer.authPropose = function authPropose(data, writer) {
  if (writer) {
    writer.writeBytes(data);
    return writer;
  }
