   ...
   */
   ...
   async syncNodeInfo() {
    try {
      ...
      this.spv = nodeInfo.spv;
      this.prune = nodeInfo.prune;
      this.emit('node info', nodeInfo);
    } catch (e) {
      this.logger.warning('Unable to get node info. Using defaults.');
      this.spv = false;
      this.prune = false;
    }
  }
