...
HTTPServer.prototype.initRouter = function initRouter() {
  ...
  // UTXO by address
  this.get('/coin/address/:address', async function(req, res) {
    var valid = req.valid();
  ...
  // UTXO by id
  this.get('/coin/:hash/:index', async function(req, res) {
    var valid = req.valid();
  ...
  // Bulk read UTXOs
  this.post('/coin/address', async function(req, res) {
    var valid = req.valid();
  ...
  // TX by hash
  this.get('/tx/:hash', async function(req, res) {
    var valid = req.valid();
    var hash = valid.hash('hash');
    var meta, view;
  ...
  // TX by address
  this.get('/tx/address/:address', async function(req, res) {
    var valid = req.valid();
    var address = valid.str('address');
    var result = [];
  ...
  // Bulk read TXs
  this.post('/tx/address', async function(req, res) {
    var valid = req.valid();
  ...
  this.get('/block/:block', async function(req, res) {
    var valid = req.valid();
  ...
  // Mempool snapshot
  this.get('/mempool', async function(req, res) {
    var result = [];
    var i, hash, hashes;
  ...
  // Reset chain
  this.post('/reset', async function(req, res) {
    var valid = req.valid();
...
HTTPServer.prototype.handleAuth = function handleAuth(socket) {
  ...
  socket.hook('get entry', async function(args) {
    var valid = new Validator([args]);
