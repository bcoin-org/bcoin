...
static void fiat_p448_carry(uint32_t out1[18], const uint32_t arg1[18]) {
  ...
  uint32_t x22 = (x20 >> 24);
  uint32_t x23 = ((x5 & UINT32_C(0x1ffffff)) + x22);
  uint32_t x24 = ((x21 >> 24) + ((x4 & UINT32_C(0x1ffffff)) + x22));
  uint32_t x25 = (x23 & UINT32_C(0x1ffffff));
  uint32_t x26 = ((x23 >> 25) + (x7 & UINT32_C(0x1ffffff)));
  ...
  uint32_t x35 = ((x24 >> 25) + (x6 & UINT32_C(0x1ffffff)));
