...
static void fiat_p251_carry_mul(uint64_t out1[5], const uint64_t arg1[5], const uint64_t arg2[5]) {
  ...
  fiat_p251_uint128 x4 = ((fiat_p251_uint128)(arg1[4]) * ((arg2[1]) * ((uint64_t)0x2 * 0x9)));
  ...
  fiat_p251_uint128 x7 = ((fiat_p251_uint128)(arg1[3]) * ((arg2[2]) * ((uint64_t)0x2 * 0x9)));
  fiat_p251_uint128 x8 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[4]) * (uint64_t)0x9));
  fiat_p251_uint128 x9 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[3]) * ((uint64_t)0x2 * 0x9)));
  fiat_p251_uint128 x10 = ((fiat_p251_uint128)(arg1[1]) * ((arg2[4]) * ((uint64_t)0x2 * 0x9)));
...
static void fiat_p251_carry(uint64_t out1[5], const uint64_t arg1[5]) {
  ...
  uint64_t x7 = ((x6 >> 51) + (x2 & UINT64_C(0x3ffffffffffff)));
  uint64_t x8 = (x6 & UINT64_C(0x7ffffffffffff));
  uint64_t x9 = (x7 & UINT64_C(0x3ffffffffffff));
  uint64_t x10 = ((x7 >> 50) + (x3 & UINT64_C(0x3ffffffffffff)));
