...
static void fiat_p251_carry_mul(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  ...
  uint64_t x9 = ((uint64_t)(arg1[9]) * ((arg2[1]) * ((uint32_t)0x2 * 0x9)));
  ...
  uint64_t x17 = ((uint64_t)(arg1[8]) * ((arg2[2]) * ((uint32_t)0x2 * 0x9)));
  ...
  uint64_t x24 = ((uint64_t)(arg1[7]) * ((arg2[3]) * ((uint32_t)0x2 * 0x9)));
  ...
  uint64_t x30 = ((uint64_t)(arg1[6]) * ((arg2[4]) * ((uint32_t)0x2 * 0x9)));
  ...
  uint64_t x35 = ((uint64_t)(arg1[5]) * ((arg2[5]) * ((uint32_t)0x2 * 0x9)));
  ...
  uint64_t x39 = ((uint64_t)(arg1[4]) * ((arg2[6]) * ((uint32_t)0x2 * 0x9)));
  uint64_t x40 = ((uint64_t)(arg1[3]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x41 = ((uint64_t)(arg1[3]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x42 = ((uint64_t)(arg1[3]) * ((arg2[7]) * ((uint32_t)0x2 * 0x9)));
  uint64_t x43 = ((uint64_t)(arg1[2]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x44 = ((uint64_t)(arg1[2]) * ((arg2[8]) * ((uint32_t)0x2 * 0x9)));
  uint64_t x45 = ((uint64_t)(arg1[1]) * ((arg2[9]) * ((uint32_t)0x2 * 0x9)));
...
static void fiat_p251_carry(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  uint32_t x15 = ((x12 >> 25) + (x3 & UINT32_C(0x1ffffff)));
